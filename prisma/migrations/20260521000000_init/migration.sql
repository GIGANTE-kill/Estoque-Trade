...
-- AddForeignKey
ALTER TABLE "solicitacoes" ADD CONSTRAINT "solicitacoes_aprovadorId_fkey" FOREIGN KEY ("aprovadorId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
